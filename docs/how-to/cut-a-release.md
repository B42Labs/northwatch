...
3. Skim the entries for accuracy and wording — this text becomes part of the
   release's story.
...
(`.github/workflows/release.yml`). Pushing the tag is the point of no return —
...
The release is meant to be verifiable end to end. After downloading an artifact
