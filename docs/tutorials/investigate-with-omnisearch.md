...
This is the heart of Northwatch: a Northbound `Logical_Switch_Port` expresses
*intent* ("this port should exist on this switch"), while the Southbound
...
The interesting cases are the ones where the chain *doesn't* complete — a port
